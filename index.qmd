...
::: columns
::: {.column width="50%"}
![](images/student_bad1.png)
![](images/student_bad2.png)
![](images/student_bad3.png)
:::

::: {.column width="50%"}
![](images/student_bad4.png)
![](images/student_bad5.png)]
![](images/student_bad6.png)
:::
:::
...
-   Pitch your visualization to data scientists at Prowise Learn in a short presentation.

-   Report, including:

    -   Your visualization

    -   1 page description explanaining your problem and visualization. Why is this the best way to visualize your data?
...
-   Clear description (1 page)

-   Aesthetic quality (is it pretty, clear, simple?)

-   Communicative quality (does it communicate what you intend it to communicate?)
