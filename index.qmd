...
-   Changes in <span class="bracketed">[score/ability]</span> over <span class="bracketed">[time/sessions/items]</span> per <span class="bracketed">[player/class/game/learning goal/time-period]</span>
    -   Prowise example: “How do first-time players improve in the first 10 sessions of the game <span class="bracketed">[Verhaaltjes]</span>?”
    -   Teacher example: “Which children are not showing the expected improvement?” <span class="bracketed">[decline / stopped growth]</span>
...
-   Make an overview of the scores of children in a classroom, for instance:
    ...
    -   Which games were played in the last <span class="bracketed">[week/month]</span>?
...
-   Example: Overview that dives deeper into the scores of a <span class="bracketed">[child/class]</span>
...
-   Can behavioral patterns in the use of the system be identified? For example:
    ...
    -   How many children play in our system per <span class="bracketed">[week/month]</span>? Any differences between the three applications <span class="bracketed">[Math Garden, Language Sea, Words&Birds]</span>?

    -   How many items have been completed per domain and/or learning goal in a <span class="bracketed">[week/month/year]</span>?

    -   Are there differences in when children play <span class="bracketed">[school hours, evening, weekend]</span>?
...
-   Pick one or two motivational variables and compute them from log record data.
    ...
    -   Examples of motivational metrics could be: <span class="bracketed">[quitting, persistence, game / difficulty selection, number of items played per login]</span>, etc …

-   Are there <span class="bracketed">[between- / within- player]</span> differences in motivation? For example:
...
-   Researcher example: Are motivation effects stable across <span class="bracketed">[time/games/age groups]</span>?

## Project 5

-   Audience: Prowise team / Data scientist

-   Investigate the scores <span class="bracketed">[expected / observed]</span> per <span class="bracketed">[item/user/groups]</span> within psychometric models. For example:

    -   How fast are the <span class="bracketed">[expected_scores]</span> converging to <span class="bracketed">[observed_scores]</span>? Show the relation with playing frequency

    -   Different categories of model misfits (e.g., discrepancies between <span class="bracketed">[expected & observed scores per item/user]</span>
