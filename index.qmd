...
::: columns
::: {.column width="50%"}
![](images/student_good7.png)
:::

::: {.column width="50%"}
![](images/student_good8.png)
:::
:::
...
::: columns
::: {.column width="50%"}
![](images/student_bad1.png) ![](images/student_bad2.jpeg)
:::

::: {.column width="50%"}
![](images/student_bad3.jpeg) ![](images/student_bad4.jpeg)\]
:::
:::
...
::: columns
::: {.column width="50%"}
![](images/student_ugly1.png) ![](images/student_ugly2.png) ![](images/student_ugly3.png)
:::

::: {.column width="50%"}
![](images/student_ugly4.png) ![](images/student_ugly5.png)\] ![](images/student_ugly6.png)
:::
:::
...
-   Run the lintr and **resolve** the issue. (We don't want to see your errors!)
...
## Final assignment {.smaller .scrollable}
...
| When                                 | What                      | Where                    |
+======================================+===========================+==========================+
| Friday, October 11th, 12:00 - 15:00  | Q&A session               | REC E0.15                |
+--------------------------------------+---------------------------+--------------------------+
| Sunday, October 13th, 23:59          | Deadline final assignment |                          |
+--------------------------------------+---------------------------+--------------------------+
| Tuesday, October 15th, 15:00 - 18:00 | Presentations             | REC-IMPACT (JK building) |
+--------------------------------------+---------------------------+--------------------------+
...
[[Indicate your project preference]{.underline}](https://docs.google.com/spreadsheets/d/1uqS1WaaLwb7F-66zmwDO9YWb8l52W6yYMwcnXyC1yhk/edit?gid=1909891562#gid=1909891562)
...
+--------------------------------------+---------------------------------+-------------+-----------------+
| When                                 | What                            | Who         | Material        |
+======================================+=================================+=============+=================+
| Friday, September 20th 12:00 - 15:00 | Session 6: Consultancy          | Robert, Abe | CRISP-DM Manual |
|                                      |                                 |             |                 |
|                                      | Interview Skills                |             |                 |
+--------------------------------------+---------------------------------+-------------+-----------------+
| Sunday, September 22nd 23:59         | Deadline: Data Vis Assignment 2 |             |                 |
+--------------------------------------+---------------------------------+-------------+-----------------+
...
| Assignment                          | Content                            | Materials                                                                                                          | Deadline                      |
+=====================================+====================================+====================================================================================================================+===============================+
| **Data Visualization Assignment 2** | \[Group\] Brainstorm final project | Lecture slides                                                                                                     | Sunday, September 22nd, 23.59 |
|                                     |                                    |                                                                                                                    |                               |
|                                     | \[Individual\] Copy this plot      | \[Read\] DV Book ch. 3.7, 4.3, 5.3, 5.5, 5.6, 6.0, 6.1, 6.2, 8.1, 8.2, 8.3                                         |                               |
|                                     |                                    |                                                                                                                    |                               |
...
# Build a Shiny App {background-color="#8000FF"}
::: footer
:::
